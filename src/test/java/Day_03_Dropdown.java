...
public class Day_03_Dropdown {
    ...
    public void dropwdown1(){
        ...
        //dropdown icerisinde ki tum secenekleri almak istersek ...
        ...
        //Toplam kategori sayisini bulma sekli
        System.out.println("Toplam Kategori sayisi:"+tumsecenekler.size());


        //sadece secilen secenegi  bizer return eder
        WebElement secili=select.getFirstSelectedOption();
        System.out.println("Su an Secili olan :"+secili);

       // dropDownAll.stream().forEach(t->System.out.println("Lamda ile :"+t.getText()));
